...
SYSTEM_PROMPT: str = f"""
    ...
    - For time-sensitive data older than one week ({datetime.now().isoformat()}), warn that it may be outdated and include the data's date.
...
DIVERSITY: float = 0.95             # Control diversity          0.1=more focused, 0.9=more diverse
FREQUENCY_PENALTY: float = 0.5     # Reduce repetition          0.0=none, 1.0=full